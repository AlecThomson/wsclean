...
void CommandLine::printHelp() {
  std::cout
      << "Syntax: wsclean [options] <input-ms> [<2nd-ms> [..]]\n"
         ...
         "   Apply solutions from the provided (h5) file to the facet center "
         "when gridding "
         "and/or degridding facet based images.\n"
         ...
         "   Only works in conjunction with -apply-facet-solutions. List "
         "should have length 2 at maximum.\n"
         "-apply-facet-beam\n"
         "   Apply beam gains to facet center when gridding and/or degridding "
         "facet based "
         "images\n"
