...
//         writer.Height(), writer.PhaseCentreDL(), writer.PhaseCentreDM(),
//         false);
...
//       cSet.StoreFacet(facets_data[facet_idx].data(), polarization, 1,
//       facet_idx,
//                       facets[facet_idx].GetBoundingBox().Width(),
//                       facets[facet_idx].GetBoundingBox().Height(), false);
//     }
//   }
...
//       cSet.LoadFacet(read_buffer.data(), polarizations[pol_idx], 1,
//       facet_idx,
//                      false);
