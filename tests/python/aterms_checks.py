...
class TestAterms:
    def test_aterms(self):
        ...
        s = f"{tcf.WSCLEAN} -size 200 200 -scale 2arcsec -niter 1 -mgain 0.7 -log-time -nmiter 1 -threshold 0.001 -gridder idg -aterm-config screen_config.cfg {tcf.MWA_MOCK_MS}"
