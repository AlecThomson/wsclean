...
ObservationInfo ReadObservationInfo(casacore::MeasurementSet& ms,
  ...
  if (fTable.keywordSet().isDefined("WSCLEAN_DL") || fTable.keywordSet().isDefined("WSCLEAN_DM")) {
    throw std::runtime_error(
      "This measurement was processed with chgcentre to have a shifted phase centre. \n"
      "This kind of shifting has been directly implemented in wsclean. Because of this,\n"
      "the chgcentre approach is no longer supported. Use chgcentre to undo the shift\n"
